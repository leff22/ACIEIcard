...
export default function EmpresaLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('🔍 Tentando login empresa:', { cnpj, password: '***' })
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Acesso para empresas associadas ACIEI
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              Problemas com o acesso? Entre em contato com a ACIEI
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-between text-center text-sm">
          ...
          <a href="/conveniado/login" className="text-green-600 hover:text-green-500">
            Sou conveniado
          </a>
        </div>
      </div>
